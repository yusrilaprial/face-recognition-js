...
const detectAndDraw = async () => {
  ...
  const detections = await faceapi.detectAllFaces(img, options).withFaceLandmarks().withFaceDescriptors().withFaceExpressions();
    ...
    <div class="max-w-md mx-auto text-center">
      ...
      <div class="space-y-2">
        ...
        <div class="flex justify-center gap-x-2">
          ...
          <button v-if="isOnWebCam" class="bg-green-500 text-white font-bold py-2 px-4 rounded"
